...
int main() {
    ...
    cout << "\n3. 测试数组操作:" << endl;
    {
        ...
        IndexAccessExpression* accessExpr = new IndexAccessExpression(arrExpr, indexExpr);
    ...
    cout << "\n4. 测试字典操作:" << endl;
    {
        ...
        IndexAccessExpression* accessExpr = new IndexAccessExpression(dictExpr, keyExpr);
    ...
    cout << "\n5. 测试字符串字符访问:" << endl;
    {
        ...
        StringLiteral* indexExpr = new StringLiteral("0");
        IndexAccessExpression* accessExpr = new IndexAccessExpression(textExpr, indexExpr);
