...
class ParserSimpleTest : public ::testing::Test {
protected:
    void SetUp() override {
        // 测试前的设置
    }
...
TEST_F(ParserSimpleTest, ConstantExpressions) {
...
TEST_F(ParserSimpleTest, ExpressionStatements) {
    ConstantExpression* intExpr = new ConstantExpression(42);
...
TEST_F(ParserSimpleTest, VariableDeclarations) {
    ConstantExpression* intExpr = new ConstantExpression(42);
...
TEST_F(ParserSimpleTest, ProgramStructure) {
    ConstantExpression* intExpr = new ConstantExpression(42);
    ExpressionStatement* exprStmt = new ExpressionStatement(intExpr);
    VariableDeclaration* varDecl = new VariableDeclaration("y", "int", intExpr);
